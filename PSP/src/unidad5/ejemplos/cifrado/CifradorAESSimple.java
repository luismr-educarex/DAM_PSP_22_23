...
/**
 * Contiene un método main que genera la clave, cifra un texto y lo almacena en un fichero.
 */
public class CifradorAESSimple {
	...
	public static void main(String[] args) {
		...
		final String TEXTO_EN_CLARO = "La clave secreta de la caja fuerte es 338383809";
